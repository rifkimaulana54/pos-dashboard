...
@section('title', 'Product Management - Import Products')
...
@section('content_header')
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="{{ url('producs') }}">Products</a></li>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header with-border">
              <h3 class="card-title">Upload Product (.xls / .xlsx only)</h3>
            </div>
            <form class="form-horizontal" action="{{ url('/products/upload/confirm') }}" method="POST" name="importform" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="card-body">
                ...
                @endif
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            ...
                            <br>
                            <a href="{{asset('excel/Template_Upload_Product.xlsx')}}"><small>download template</small></a>
              ...
              <div class="card-footer">
                <a href="{{ url('/producs') }}" class="btn btn-default" title="back to calculator list">Back</a>
                <button class="btn btn-primary d-none" type="submit" id="btnSubmit">
                    <i class="fa fa-fw fa-upload"></i> Upload
                </button>
              </div>
              <!-- /.box-footer -->
